...
export const step4Schema = z.object({
  ...
  goals_after: z.string().max(500, 'Goals must not exceed 500 characters').optional(),
  heard_about: z.string().min(1, 'Please select how you heard about us'),
});
